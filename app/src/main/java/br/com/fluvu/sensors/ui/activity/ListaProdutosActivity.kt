...
import br.com.fluvu.sensors.databinding.ActivityListaProdutosActivityBinding
import br.com.fluvu.sensors.ui.recyclerview.adapter.ListaProdutosAdapter
...
class ListaProdutosActivity : UsuarioBaseActivity() {
    ...
    private suspend fun buscaProdutosUsuario() {
        produtoDao.searchAll().collect { produtos ->
